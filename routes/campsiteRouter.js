...
campsiteRouter.route('/')
    ...
    .post(authenticate.verifyUser, (req, res, next) => { //CREATE
    ...
    .delete(authenticate.verifyUser, (req, res, next) => { //DESTROYS
...
campsiteRouter.route('/:campsiteId')
    ...
    .put(authenticate.verifyUser, (req, res, next) => { //UPDATE
        Campsite.findByIdAndUpdate(req.params.campsiteId, { //find a campsite schema by its id in the url/param and update
            $set: req.body //update through body 
        }, { new: true }) //returns the modified/updated schema
            .then(campsite => {
                res.statusCode = 200;
                res.setHeader('Content-Type', 'application/json');
                res.json(campsite);
